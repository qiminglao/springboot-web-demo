...
public class CodeGenerator {
    ...
    public static void getCode() {
        //TODO 修改为自己的数据库信息
        String url = "jdbc:mysql://localhost:3306/test01?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=Asia/Shanghai";
        String username = "root";
        String password = "root";
        //TODO 修改为自己的表名
        List<String> tables = List.of("tablea", "tableb");//需要生成对应代码的表名的集合

        FastAutoGenerator.create(url, username, password)
                //全局配置----------------------------------------------------------------------------------------
                .globalConfig(builder -> {
                    builder
                            .author("allen.lao")//TODO 修改为自己名称
                ...
                .packageConfig(builder ->
                        builder.parent("com.example.demo")//TODO 修改为自己项目的路径
